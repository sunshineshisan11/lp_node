...
// 读取证书和私钥文件
const options = {
    key: fs.readFileSync(path.join(__dirname, 'cert', 's295394516_findyourflame.vip_server.key')),
    cert: fs.readFileSync(path.join(__dirname, 'cert', 's295394516_findyourflame.vip_server.crt')),
};
